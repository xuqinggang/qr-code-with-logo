...
var drawLogo = function drawLogo(_ref) {
  ...
  var _logo$logoSize = logo.logoSize,
      ...
      _logo$borderWidth = logo.borderWidth,
      borderWidth = _logo$borderWidth === undefined ? 2 : _logo$borderWidth,
      borderHeight = logo.borderHeight;
  ...
  var logoY = (canvasHeight - logoHeight) / 2;
  ...
  if (borderWidth !== 0 || borderHeight !== 0) {
    var logoBgWidth = borderWidth * 2 + logoWidth;
    var logoBgHeight = borderHeight * 2 + logoHeight;
    var logoBgX = (canvasWidth - logoBgWidth) / 2;
    var logoBgY = (canvasHeight - logoBgHeight) / 2;
